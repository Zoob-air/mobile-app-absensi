...
export default function AdminProfileScreen() {
  ...
  if (loading) {
    return <Loading text="Memuat profile admin..." />;
  }

  return (
    <View style={styles.container}>
      <Header title="Admin Profile" subtitle="Informasi akun administrator" />

      <View style={styles.avatarBox}>
        <Text style={styles.avatarText}>{user?.nama?.charAt(0) || "A"}</Text>
      </View>
